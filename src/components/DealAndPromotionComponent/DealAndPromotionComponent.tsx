...
const DealAndPromotionComponent = () => {
  ...
  React.useEffect(() => {
    if (data) {
      const filterData = data.data.products.filter(
        (prod) => prod.discount.length > 0
      );
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} lg={9}>
            ...
            <Grid container spacing={2}>
              {/* {
                product?.products.filter((prod) => prod.discount.length > 0);
              } */}
...
export default DealAndPromotionComponent;
